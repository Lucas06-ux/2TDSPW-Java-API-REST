...
public interface ProdutoRepository extends JpaRepository<Produto, UUID> {
    ...
    List<Produto> findByNomeLike(String pattern); //a%b%c
    ...
    List<Produto> findByPrecoGreaterThanAndCategoriaIs(BigDecimal preco, Categoria categoria);
    ...
    @Query(value = "SELECT * FROM TB_PRODUTOS WHERE preco_produto > 100 AND categoria = ?1 AND nome = ?2", nativeQuery = true)
    List<Produto> encontrarProdutosCaros(String categoria, String nome);
