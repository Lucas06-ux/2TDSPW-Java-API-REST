...
public class ProdutoMapper {
    public ProdutoResponse produtoToResponse(Produto produto){
        //Link para a lista de produtos, ou seja, metodo read(pageable) do controller
    ...
    public ProdutoLista produtoToProdutoLista(Produto produto){
        ...
        //Link para um metedo da classe produto controller que é o readProduto,
        // procurando pelo id do produto, com a relação rel
